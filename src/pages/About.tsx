    ...
    <FramerContainer>
      <div className="space-y-5 my-5">
        ...
        <div className="space-y-3">
          ...
          <p>
            Our platform is built on the values of accessibility,
            sustainability, and community. We strive to make bike rentals
            simple, affordable, and accessible to everyone. By offering a
            diverse range of bikes, we aim to support eco-friendly travel and
            encourage a healthier, more active lifestyle. Our commitment to
            customer satisfaction drives everything we do, from our
            user-friendly booking process to our responsive customer support.
          </p>
        </div>
            ...
            {teamMembers.map((member, index) => {
              return (
                ...
                >
                  <img
                    src={member.imgSrc}
                    className="w-52 border rounded-full h-52 object-contain"
                  />
